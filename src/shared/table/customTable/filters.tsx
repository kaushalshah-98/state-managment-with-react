...
const activeIconClassName =
  'relative left-2  text-purplee-600 cursor-pointer hover:text-purplee-700';
const BtnClass =
          ...
          <>
            <div className=" absolute mt-3 rounded-lg shadow-lg">
              <div className="rounded-lg bg-white shadow-lg border border-solid border-input-border">
                ...
                >
                  <div
                    className="cursor-pointer px-3 py-2 text-sm leading-5 text-customgray-400 my-2"
                    role="menuitem"
                  >
                    ...
                    <InputLabel
                      ...
                      register={register}
                      placeHolder="Search.."
                      inputClass="mt-1 hover:border-purplee-400 form-input block w-44 py-1 px-2 focus:shadow-sm font-ubuntu border border-grayy-400 rounded-md shadow-sm focus:outline-none focus:shadow-outline-redd focus:border-purplee-600 transition duration-150 ease-in-out sm:text-sm sm:leading-5"
                      name="searchString"
                    />
                    {/* <div className="flex justify-between mt-2">
                      <button
                        onClick={handleSubmit(onSearch)}
                        className=" flex mr-2 w-16 justify-center  mt-1 bg-purplee-500 px-auto py-1 rounded text-center text-gray-100 "
                      >
                        Search
                      </button>
                      <button
              ...
              <div className="rounded-lg bg-white py-2 shadow-lg border border-solid border-input-border">
                <div className="mx-3 ">
                  <InputLabel
                    ...
                    inputClass="mt-1 form-input block hover:border-purplee-600 py-1 focus:shadow-sm font-ubuntu border border-grayy-400 rounded-md shadow-sm focus:outline-none focus:shadow-outline-redd focus:border-purplee-600 transition duration-150 ease-in-out sm:text-sm sm:leading-5"
                    name="searchString"
                  />
                        ...
                        >
                          <div className="flex items-center space-x-4 px-3 ">
                            <input
                              ...
                              className="form-checkbox ml-3 h-4 w-4 rounded-md text-purplee-500 transition duration-150 ease-in-out bg-gray-200"
                            />
                            <label
    ...
    <>
      <WatchClickOutside onClickOutside={() => (open ? {} : setstate(false))}>
        ...
        {state && (
          <>
            <div className="origin-top-right z-10 absolute mt-3 rounded-lg shadow-lg">
              <div className="rounded-lg bg-white py-2 px-1 shadow-lg border border-solid border-input-border">
                <div className=" flex space-x-1 mr-3 -mt-1 justify-end">
                  <button onClick={() => remove()} type="button" className={BtnClass}>
                    <FeatherIcon.X size="20" />
                  </button>
                  <button onClick={() => apply()} type="button" className={BtnClass}>
                ...
                <div className="pt-3 pl-1 pr-3 pb-2">
