    ...
    <div className="flex items-center">
        ...
        <>
          {props?.viewProp && (
            <button
              ...
              className={
                viewClass ||
                'mr-2 text-gray-600 p-2 rounded-full hover:bg-purplee-50 focus:text-gray-800'
              }
            >
      ...
      <WatchClickOutside onClickOutside={() => setshowDiv(false)}>
        {props.Action && (
          <button
            onClick={toggle}
            className="mr-3 mt-1 p-2 rounded-full hover:bg-purplee-50 -ml-2 text-gray-600 focus:text-gray-800"
          >
